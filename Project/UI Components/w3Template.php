...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container">
    ...
    <img src="/C:\Users\Robbie\Documents\CSC 450\CSC_450\Project\Images\Logo.png" style="width:45%;" class="w3-round"><br><br>
    <h4><b>PORTFOLIO</b></h4>
...
<!-- Header -->
  <header id="portfolio">
    <a href="#"><img src="C:\Users\Robbie\Documents\CSC 450\CSC_450\Project\Images\Logo.png" style="width:65px;" class="w3-circle w3-right w3-margin w3-hide-large w3-hover-opacity"></a>
...
-->
  ...
  <div class="w3-container w3-padding-large w3-grey">
    ...
    <hr class="w3-opacity">
    <form method = "post" action="C:\Users\Robbie\Documents\CSC 450\CSC_450\Project\UI Components\message_page.php" target="_blank">
